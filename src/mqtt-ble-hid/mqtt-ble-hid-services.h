...
const uint8_t profile_data[] =
{
    ...
    // 0x0003 VALUE-GAP_DEVICE_NAME-READ-'MQTT HID Bridge'
    // READ_ANYBODY
    0x17, 0x00, 0x02, 0x00, 0x03, 0x00, 0x00, 0x2a, 0x4d, 0x51, 0x54, 0x54, 0x20, 0x48, 0x49, 0x44, 0x20, 0x42, 0x72, 0x69, 0x64, 0x67, 0x65, 
    // add Battery Service
    ...
    // fixed report id = 3, type = Output (3)
    // 0x0029 REPORT_REFERENCE-READ-3-2
    0x0a, 0x00, 0x02, 0x00, 0x29, 0x00, 0x08, 0x29, 0x3, 0x2, 
    ...
    // 0x002b VALUE-ORG_BLUETOOTH_CHARACTERISTIC_REPORT-DYNAMIC | READ | WRITE | NOTIFY | ENCRYPTION_KEY_SIZE_16-''
    // READ_ENCRYPTED, WRITE_ENCRYPTED, ENCRYPTION_KEY_SIZE=16
    ...
    // fixed report id = 4, type = Feature (3)
    // 0x002d REPORT_REFERENCE-READ-4-3
    0x0a, 0x00, 0x02, 0x00, 0x2d, 0x00, 0x08, 0x29, 0x4, 0x3, 
    // 0x002e CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_REPORT_MAP-DYNAMIC | READ
    0x0d, 0x00, 0x02, 0x00, 0x2e, 0x00, 0x03, 0x28, 0x02, 0x2f, 0x00, 0x4b, 0x2a, 
    // 0x002f VALUE-ORG_BLUETOOTH_CHARACTERISTIC_REPORT_MAP-DYNAMIC | READ-''
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x01, 0x2f, 0x00, 0x4b, 0x2a, 
    // 0x0030 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT-DYNAMIC | READ | WRITE | NOTIFY
    0x0d, 0x00, 0x02, 0x00, 0x30, 0x00, 0x03, 0x28, 0x1a, 0x31, 0x00, 0x22, 0x2a, 
    // 0x0031 VALUE-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT-DYNAMIC | READ | WRITE | NOTIFY-''
    // READ_ANYBODY, WRITE_ANYBODY
    0x08, 0x00, 0x0a, 0x01, 0x31, 0x00, 0x22, 0x2a, 
    // 0x0032 CLIENT_CHARACTERISTIC_CONFIGURATION
    // READ_ANYBODY, WRITE_ANYBODY
    0x0a, 0x00, 0x0e, 0x01, 0x32, 0x00, 0x02, 0x29, 0x00, 0x00, 
    // 0x0033 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_OUTPUT_REPORT-DYNAMIC | READ | WRITE | WRITE_WITHOUT_RESPONSE
    0x0d, 0x00, 0x02, 0x00, 0x33, 0x00, 0x03, 0x28, 0x0e, 0x34, 0x00, 0x32, 0x2a, 
    // 0x0034 VALUE-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_OUTPUT_REPORT-DYNAMIC | READ | WRITE | WRITE_WITHOUT_RESPONSE-''
    // READ_ANYBODY, WRITE_ANYBODY
    0x08, 0x00, 0x0e, 0x01, 0x34, 0x00, 0x32, 0x2a, 
    // 0x0035 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT-DYNAMIC | READ | WRITE | NOTIFY
    0x0d, 0x00, 0x02, 0x00, 0x35, 0x00, 0x03, 0x28, 0x1a, 0x36, 0x00, 0x33, 0x2a, 
    // 0x0036 VALUE-ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT-DYNAMIC | READ | WRITE | NOTIFY-''
    // READ_ANYBODY, WRITE_ANYBODY
    0x08, 0x00, 0x0a, 0x01, 0x36, 0x00, 0x33, 0x2a, 
    ...
    // 0x0038 CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HID_INFORMATION-READ
    0x0d, 0x00, 0x02, 0x00, 0x38, 0x00, 0x03, 0x28, 0x02, 0x39, 0x00, 0x4a, 0x2a, 
    // 0x0039 VALUE-ORG_BLUETOOTH_CHARACTERISTIC_HID_INFORMATION-READ-'01 01 00 02'
    // READ_ANYBODY
    0x0c, 0x00, 0x02, 0x00, 0x39, 0x00, 0x4a, 0x2a, 0x01, 0x01, 0x00, 0x02, 
    // 0x003a CHARACTERISTIC-ORG_BLUETOOTH_CHARACTERISTIC_HID_CONTROL_POINT-DYNAMIC | WRITE_WITHOUT_RESPONSE
    0x0d, 0x00, 0x02, 0x00, 0x3a, 0x00, 0x03, 0x28, 0x04, 0x3b, 0x00, 0x4c, 0x2a, 
    // 0x003b VALUE-ORG_BLUETOOTH_CHARACTERISTIC_HID_CONTROL_POINT-DYNAMIC | WRITE_WITHOUT_RESPONSE-''
    // WRITE_ANYBODY
    0x08, 0x00, 0x04, 0x01, 0x3b, 0x00, 0x4c, 0x2a, 
    // #import <hids_remote.gatt> -- END

    // 0x003c PRIMARY_SERVICE-GATT_SERVICE
    0x0a, 0x00, 0x02, 0x00, 0x3c, 0x00, 0x00, 0x28, 0x01, 0x18, 
    // 0x003d CHARACTERISTIC-GATT_SERVICE_CHANGED-READ
    0x0d, 0x00, 0x02, 0x00, 0x3d, 0x00, 0x03, 0x28, 0x02, 0x3e, 0x00, 0x05, 0x2a, 
    // 0x003e VALUE-GATT_SERVICE_CHANGED-READ-''
    // READ_ANYBODY
    0x08, 0x00, 0x02, 0x00, 0x3e, 0x00, 0x05, 0x2a, 
...
#define ATT_SERVICE_ORG_BLUETOOTH_SERVICE_HUMAN_INTERFACE_DEVICE_END_HANDLE 0x003b
#define ATT_SERVICE_GATT_SERVICE_START_HANDLE 0x003c
#define ATT_SERVICE_GATT_SERVICE_END_HANDLE 0x003e
...
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_REPORT_04_VALUE_HANDLE 0x002b
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_REPORT_04_CLIENT_CONFIGURATION_HANDLE 0x002c
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_REPORT_MAP_01_VALUE_HANDLE 0x002f
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT_01_VALUE_HANDLE 0x0031
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_INPUT_REPORT_01_CLIENT_CONFIGURATION_HANDLE 0x0032
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_KEYBOARD_OUTPUT_REPORT_01_VALUE_HANDLE 0x0034
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT_01_VALUE_HANDLE 0x0036
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_BOOT_MOUSE_INPUT_REPORT_01_CLIENT_CONFIGURATION_HANDLE 0x0037
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_HID_INFORMATION_01_VALUE_HANDLE 0x0039
#define ATT_CHARACTERISTIC_ORG_BLUETOOTH_CHARACTERISTIC_HID_CONTROL_POINT_01_VALUE_HANDLE 0x003b
#define ATT_CHARACTERISTIC_GATT_SERVICE_CHANGED_01_VALUE_HANDLE 0x003e
